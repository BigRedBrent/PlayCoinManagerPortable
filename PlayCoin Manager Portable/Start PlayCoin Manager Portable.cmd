...
SET PLAYCLOUDCOINMANAGERPORTABLE_version=1.1
...
SET PLAYCLOUDCOINMANAGERPORTABLE_manager_list=%PLAYCLOUDCOINMANAGERPORTABLE_manager_list% "%ProgramFiles(x86)%\CloudCoin Consortium\PlayCoin Manager\cc_gl2\playcoin_manager.exe"
SET PLAYCLOUDCOINMANAGERPORTABLE_manager_list=%PLAYCLOUDCOINMANAGERPORTABLE_manager_list% "%ProgramFiles%\CloudCoin Consortium\PlayCoin Manager\cc_gl2\playcoin_manager.exe"
